...
let item2 =new Constructor('Awesome shoes','This is better than the fake',700,'https://i.postimg.cc/prTPs7yB/product1.webp')
let item3 =new Constructor('Amazing','This is better than the fake',700,'https://i.postimg.cc/MTHLN8bX/Product-3.webp')
let item4 =new Constructor('siya','This is better than the fake',700,'https://i.postimg.cc/XJyvWtn7/product-4.jpg')
let item5 =new Constructor('Another nike','This is better than the fake',700,'https://i.postimg.cc/sDL0Q8zR/product-5.webp')
let item6 =new Constructor('Another nike','This is better than the fake',700,'https://i.postimg.cc/QMdSdGYD/product6.jpg')
